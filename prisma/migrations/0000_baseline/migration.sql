...
CREATE TABLE `categories` (
    ...
    UNIQUE INDEX `categories_submenuId_position_key`(`submenuId`, `position`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `subcategories` (
    ...
    UNIQUE INDEX `subcategories_categoryId_position_key`(`categoryId`, `position`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `submenus` (
    ...
    UNIQUE INDEX `submenus_menuId_position_key`(`menuId`, `position`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
