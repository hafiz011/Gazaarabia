...
CREATE TABLE `addresses` (
    ...
    INDEX `addresses_userId_fkey`(`userId` ASC),
    PRIMARY KEY (`id` ASC)
...
CREATE TABLE `affiliate` (
    ...
    UNIQUE INDEX `Affiliate_userId_unique`(`userId` ASC),
...
CREATE TABLE `affiliate_bank_accounts` (
    ...
    UNIQUE INDEX `affiliate_bank_accounts_affiliateId_key`(`affiliateId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `affiliate_invoice` (
    ...
    INDEX `affiliate_invoice_affiliateId_fkey`(`affiliateId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `ambassador_invoice` (
    ...
    INDEX `ambassador_invoice_ambassadorId_fkey`(`ambassadorId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `blog_categories` (
    ...
    UNIQUE INDEX `blog_categories_name_key`(`name` ASC),
    UNIQUE INDEX `blog_categories_slug_key`(`slug` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `blogs` (
    ...
    UNIQUE INDEX `Blogs_slug_key`(`slug` ASC),
    INDEX `blogs_categoryId_fkey`(`categoryId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `brand` (
    ...
    UNIQUE INDEX `Brand_name_key`(`name` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `carts` (
    ...
    INDEX `carts_colorId_fkey`(`colorId` ASC),
    INDEX `carts_productId_fkey`(`productId` ASC),
    INDEX `carts_sizeId_fkey`(`sizeId` ASC),
    UNIQUE INDEX `carts_userId_variantId_key`(`userId` ASC, `variantId` ASC),
    INDEX `carts_variantId_fkey`(`variantId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `category_commissions` (
    ...
    UNIQUE INDEX `category_commissions_categoryId_key`(`categoryId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `charity_donations` (
    ...
    UNIQUE INDEX `charity_donations_orderId_key`(`orderId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `colors` (
    ...
    UNIQUE INDEX `colors_name_key`(`name` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `coupon` (
    ...
    INDEX `coupon_affiliateId_fkey`(`affiliateId` ASC),
    UNIQUE INDEX `coupon_code_key`(`code` ASC),
    INDEX `coupon_creatorId_fkey`(`creatorId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `faq_categories` (
    ...
    UNIQUE INDEX `faq_categories_name_key`(`name` ASC),
    UNIQUE INDEX `faq_categories_slug_key`(`slug` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `faqs` (
    ...
    INDEX `faqs_categoryId_fkey`(`categoryId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `menus` (
    ...
    INDEX `menus_blogCategoryId_fkey`(`blogCategoryId` ASC),
    INDEX `menus_categoryId_fkey`(`categoryId` ASC),
    UNIQUE INDEX `menus_slug_key`(`slug` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `orders` (
    ...
    INDEX `orders_affiliateId_fkey`(`affiliateId` ASC),
    INDEX `orders_ambassadorId_fkey`(`ambassadorId` ASC),
...
CREATE TABLE `orders_item` (
    ...
    INDEX `orders_item_ambassadorId_fkey`(`ambassadorId` ASC),
    INDEX `orders_item_orderId_fkey`(`orderId` ASC),
    INDEX `orders_item_productId_fkey`(`productId` ASC),
    INDEX `orders_item_sellerId_fkey`(`sellerId` ASC),
    INDEX `orders_item_variantId_fkey`(`variantId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `payout` (
    ...
    INDEX `Payout_affiliateId_fkey`(`affiliateId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `product_relations` (
    ...
    INDEX `product_relations_childId_fkey`(`childId` ASC),
    UNIQUE INDEX `product_relations_parentId_childId_relationType_key`(`parentId` ASC, `childId` ASC, `relationType` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
    ...
    INDEX `Products_brandId_fkey`(`brandId` ASC),
    INDEX `Products_categoryId_fkey`(`categoryId` ASC),
    INDEX `Products_subcategoryId_fkey`(`subcategoryId` ASC),
    INDEX `products_ambassadorId_fkey`(`ambassadorId` ASC),
    INDEX `products_materialCareId_fkey`(`materialCareId` ASC),
    INDEX `products_sellerId_idx`(`sellerId` ASC),
...
CREATE TABLE `productvariant` (
    ...
    INDEX `ProductVariant_productId_fkey`(`productId` ASC),
    INDEX `productvariant_colorId_fkey`(`colorId` ASC),
    INDEX `productvariant_sizeId_fkey`(`sizeId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `return_reasons` (
    ...
    UNIQUE INDEX `return_reasons_label_key`(`label` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `return_requests` (
    ...
    INDEX `return_requests_orderId_fkey`(`orderId` ASC),
    INDEX `return_requests_orderItemId_fkey`(`orderItemId` ASC),
    INDEX `return_requests_reasonId_fkey`(`reasonId` ASC),
    INDEX `return_requests_userId_fkey`(`userId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `review` (
    ...
    INDEX `review_orderItemId_fkey`(`orderItemId` ASC),
    INDEX `review_productId_fkey`(`productId` ASC),
    INDEX `review_userId_fkey`(`userId` ASC),
    INDEX `review_variantId_fkey`(`variantId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `seller_payouts` (
    ...
    INDEX `seller_payouts_sellerId_idx`(`sellerId` ASC),
    INDEX `seller_payouts_status_idx`(`status` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `sellers` (
    ...
    UNIQUE INDEX `sellers_shopSlug_key`(`shopSlug` ASC),
    INDEX `sellers_status_idx`(`status` ASC),
    INDEX `sellers_userId_idx`(`userId` ASC),
    UNIQUE INDEX `sellers_userId_key`(`userId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `sizes` (
    ...
    UNIQUE INDEX `sizes_name_key`(`name` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `subcategories` (
    ...
    INDEX `subcategories_categoryId_fkey`(`categoryId` ASC),
    UNIQUE INDEX `subcategories_name_key`(`name` ASC),
    UNIQUE INDEX `subcategories_slug_key`(`slug` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `subcategorycommission` (
    ...
    UNIQUE INDEX `SubcategoryCommission_subcategoryId_key`(`subcategoryId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `submenus` (
    ...
    `categoryId` INTEGER NULL,
    `subcategoryId` INTEGER NULL,
    `leftSubcategories` LONGTEXT NULL,
    `rightSubcategories` LONGTEXT NULL,
    `leftCustomLinks` LONGTEXT NULL,
    `rightCustomLinks` LONGTEXT NULL,
    `position` INTEGER NOT NULL DEFAULT 0,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,

    INDEX `submenus_categoryId_fkey`(`categoryId` ASC),
    INDEX `submenus_menuId_fkey`(`menuId` ASC),
    UNIQUE INDEX `submenus_slug_key`(`slug` ASC),
    INDEX `submenus_subcategoryId_fkey`(`subcategoryId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `subscribers` (
    ...
    UNIQUE INDEX `subscribers_email_key`(`email` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
    ...
    INDEX `users_roleId_fkey`(`roleId` ASC),
    UNIQUE INDEX `users_stripeCustomerId_key`(`stripeCustomerId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `variant_images` (
    ...
    INDEX `variant_images_productId_fkey`(`productId` ASC),
    INDEX `variant_images_variantId_fkey`(`variantId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `wishlist` (
    ...
    INDEX `wishlist_productId_fkey`(`productId` ASC),
    UNIQUE INDEX `wishlist_userId_productId_key`(`userId` ASC, `productId` ASC),
    PRIMARY KEY (`id` ASC)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
