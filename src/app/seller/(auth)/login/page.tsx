...
export default function SellerLoginPage() {
  ...
  useEffect(() => {
    const rememberedEmail = loadWithExpiry("gaza_arabia_remember_seller");
    if (rememberedEmail) {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (form.rememberMe) {
        saveWithExpiry("gaza_arabia_remember_seller", form.email);
      } else {
        localStorage.removeItem("gaza_arabia_remember_seller");
      }
      ...
      <div className="w-full max-w-md mx-4 z-10">
        <div className="bg-white shadow-2xl rounded-2xl overflow-hidden border border-gray-100">
          ...
          <div className="px-6 py-8 text-center bg-gradient-to-r from-[var(--brand-primary)] to-[var(--brand-secondary)] text-white">
            ...
            <p className="text-sm opacity-90 mt-1">Access your Seller dashboard</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="px-6 py-8 space-y-6 bg-white">
            ...
            <p className="text-xs text-center text-gray-500">
              ...
              <a href="/seller/register" className="text-[var(--brand-primary)] hover:underline font-medium">
                Register here
              </a>
            </p>
          </form>
