...
export default function DashboardPage() {
  ...
  const sections = [
    ...
    { key: "orders", label: "Orders", icon: <ClipboardCheck size={28} />, path: "/seller/orders" },
    ...
    { key: "deliveryOptions", label: "Delivery Options", icon: <Truck size={28} />, path: "/seller/delivery-options" },
    // { key: "materialCares", label: "Material Cares", icon: <Droplets size={28} />, path: "/admin/material-cares" },
    { key: "products", label: "Products", icon: <ShoppingBag size={28} />, path: "/seller/products" },
  ];
