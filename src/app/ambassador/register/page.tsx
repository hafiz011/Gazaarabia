    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await authService.signup({
                ...
                phone: form.phone,
                role: "ambassador", // resolves to an affiliate-role user with type "ambassador"
            });

            setAlert({
                isOpen: true,
                type: "success",
                message: "Ambassador account created successfully! Redirecting to login…",
            });
            ...
            setTimeout(() => router.push(ROUTES.AMBASSADOR.LOGIN), 1200);
        } catch (err: any) {
            setAlert({
                isOpen: true,
                type: "error",
            ...
            <div className="mt-5 w-full max-w-2xl bg-white shadow-lg rounded-2xl p-10 border border-[var(--soft-gray)] transition-all duration-300 hover:shadow-xl">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                        ...
                        >
                            {loading ? "Creating account…" : "Sign Up as Ambassador"}
                        </button>
                    </div>
                </form>
                ...
                <p className="text-center text-xs text-[var(--text-muted)] mt-2">
                    Prefer to earn through referral links and coupons?{" "}
                    <a
