...
function SortableRow({ submenu, idx, startIndex, openMenu }: any) {
  ...
  return (
    ...
    >
      ...
      <td className="py-3 px-3 text-gray-700">
        {submenu.category ? submenu.category.name : (
          <span className="text-gray-400 italic">—</span>
        )}
      </td>
      ...
      <td className="py-3 px-3 text-center">
        <IconButton onClick={(e) => openMenu(e, submenu.id)}>
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="bg-white rounded-xl shadow border border-gray-200 overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 p-4">
          <h1 className="text-xl font-semibold text-gray-800">Manage Submenus</h1>
        ...
        <div className="overflow-x-auto">
          {/* <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
            <SortableContext items={submenus} strategy={verticalListSortingStrategy}> */}
